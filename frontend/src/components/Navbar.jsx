    ...
    <nav className="bg-gray-900 text-white shadow-lg">
          ...
          <div className="flex-1 flex items-center justify-between">
            ...
            <div className="hidden sm:block">
              <div className="flex space-x-4">
                ...
                <Link to="/seasons" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                  Temporadas
                </Link>
                <Link to="/episodes" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                  Episódios
                </Link>
              </div>
            </div>
      ...
      <div className={`${isOpen ? 'block' : 'hidden'} sm:hidden`} id="mobile-menu">
        <div className="px-2 pt-2 pb-3 space-y-1">
          ...
          <Link to="/seasons" className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">
            Temporadas
          </Link>
          <Link to="/episodes" className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">
            Episódios
          </Link>
        </div>
      </div>
